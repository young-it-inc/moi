...
public class ContractDto {
    ...
    String	orderingContractNo; //발주처계약번호
    ...
    String	openingDate; //착수일
    String	approximateDate; //완료예정일
    String	dueDate; //완료일
    ...
    String	billingDate; //청구일
    String	isBilled; //청구여부
    String	firstBillingDate; //1차 청구일
    long	firstBillingAmount; //1차 청구금액
    String	secondBillingDate; //2차 청구일
    long	secondBillingAmount; //2차 청구금액
    String	thirdBillingDate; //3차 청구일
    long	thirdBillingAmount; //3차 청구금액
    String	fourthBillingDate; //4차 청구일
    long	fourthBillingAmount; //4차 청구금액
    String	isGuaranted; //계약보증유무 Y/N
    String	guarantyDate; //계약보증일
    Boolean	isWarranted; //하자보증유무
    String	warrantyDate; //하자보증일
